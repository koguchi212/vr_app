...
def schedule_blender_render():
    scheduler = BackgroundScheduler()
    scheduler.add_job(render_with_latest_prompt, 'interval', seconds=5)  # 5秒ごとに実行
    scheduler.start()
...
if __name__ == '__main__':
    ...
    # blender.pyを実行するスクリプトをインポート
    schedule_blender_render()
